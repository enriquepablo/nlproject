...
class cms_test(object):
    ...
    def second_test(self):
        ...
        assert not nl.kb.app.root()['props'].has_key('c1 has what private at %s.0' % nl.time._now)
        assert nl.kb.app.root()['props'].has_key('c1 has what public at %s.0' % nl.time._now)
