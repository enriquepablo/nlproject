...
(defclass Context (is-a Thing))
(defclass Permission (is-a Thing))
(defclass Can (is-a State) (slot at (type INSTANCE)) (slot perm (type INSTANCE)))
(defclass IsIn (is-a State) (slot group (type INSTANCE)))
(defclass Has (is-a State) (slot role (type INSTANCE)) (slot at (type INSTANCE)))
(defclass User (is-a Thing))
(defclass Group (is-a User))
(defclass Role (is-a User))
(defclass Context (is-a Thing))
...
(defclass IsIn (is-a State) (slot group (type INSTANCE)))
(defclass Has (is-a State) (slot role (type INSTANCE)) (slot at (type INSTANCE)))
(make-instance [admin] of User)
(make-instance [anonymous] of Role)
(make-instance [member] of Role)
(make-instance [manager] of Role)
(make-instance [base] of Context)
(make-instance [basic_perm] of Permission)
(make-instance of Proposition (subject [admin]) (predicate (make-instance of Has (role [manager]) (at [base]))) (time now))
(defrule r1 (logical (object (is-a Proposition) (subject ?X1&:(eq (class ?X1) User)|:(subclassp (class ?X1) User)) (predicate ?Y1&:(eq (class ?Y1) Has)|:(subclassp (class ?Y1) Has)) (time ?X3))) (logical (object (is-a Proposition) (subject ?X2&:(eq ?X2 (send ?Y1 get-role))) (predicate ?Y2&:(eq (class ?Y2) Can)|:(subclassp (class ?Y2) Can)&:(eq (send ?Y2 get-at) (send ?Y1 get-at))) (time ?X3))) => (make-instance of Proposition (subject ?X1) (predicate (make-instance of Can (at (send ?Y1 get-at)) (perm (send ?Y2 get-perm)))) (time ?X3)))
(defrule r2 (logical (object (is-a Proposition) (subject ?X1&:(eq (class ?X1) User)|:(subclassp (class ?X1) User)) (predicate ?Y3&:(eq (class ?Y3) IsIn)|:(subclassp (class ?Y3) IsIn)) (time ?X3))) (logical (object (is-a Proposition) (subject ?X2&:(eq ?X2 (send ?Y3 get-group))) (predicate ?Y4&:(eq (class ?Y4) Can)|:(subclassp (class ?Y4) Can)) (time ?X3))) => (make-instance of Proposition (subject ?X1) (predicate (make-instance of Can (at (send ?Y4 get-at)) (perm (send ?Y4 get-perm)))) (time ?X3)))
(defrule r3 (logical (object (is-a Context) (name ?X4))) (logical (object (is-a Proposition) (subject ?X1&:(eq (class ?X1) User)|:(subclassp (class ?X1) User)) (predicate ?Y5&:(eq (class ?Y5) Has)|:(subclassp (class ?Y5) Has)&:(eq (send ?Y5 get-at) [base])) (time ?X3))) => (make-instance of Proposition (subject ?X1) (predicate (make-instance of Has (role (send ?Y5 get-role)) (at ?X4))) (time ?X3)))
(defclass Name (is-a USER))
(defclass Thing (is-a Name))
(defclass Verb (is-a USER))
(defclass State (is-a Verb) )
...
(defrule r2 (logical (object (is-a Proposition) (subject ?X1&:(eq (class ?X1) User)|:(subclassp (class ?X1) User)) (predicate ?Y3&:(eq (class ?Y3) IsIn)|:(subclassp (class ?Y3) IsIn)) (time ?X3))) (logical (object (is-a Proposition) (subject ?X2&:(eq ?X2 (send ?Y3 get-group))) (predicate ?Y4&:(eq (class ?Y4) Can)|:(subclassp (class ?Y4) Can)) (time ?X3))) => (make-instance of Proposition (subject ?X1) (predicate (make-instance of Can (at (send ?Y4 get-at)) (perm (send ?Y4 get-perm)))) (time ?X3)))
(defrule r3 (logical (object (is-a Context) (name ?X4))) (logical (object (is-a Proposition) (subject ?X1&:(eq (class ?X1) User)|:(subclassp (class ?X1) User)) (predicate ?Y5&:(eq (class ?Y5) Has)|:(subclassp (class ?Y5) Has)&:(eq (send ?Y5 get-at) [base])) (time ?X3))) => (make-instance of Proposition (subject ?X1) (predicate (make-instance of Has (role (send ?Y5 get-role)) (at ?X4))) (time ?X3)))
(make-instance [juan] of User)
(make-instance [pedro] of User)
(make-instance [ana] of User)
(make-instance [grandes] of Group)
(defclass Name (is-a USER))
(defclass Thing (is-a Name))
(defclass Verb (is-a USER))
(defclass State (is-a Verb) )
...
(make-instance [pedro] of User)
(make-instance [ana] of User)
(make-instance [hombres] of Group)
(make-instance [mujeres] of Group)
(make-instance [it] of Group)
(make-instance [finanzas] of Group)
(make-instance [jefe] of Role)
(make-instance [presidente] of Role)
(make-instance [it] of Context)
(make-instance [finanzas] of Context)
(defclass Name (is-a USER))
(defclass Thing (is-a Name))
(defclass Verb (is-a USER))
(defclass State (is-a Verb) )
...
(make-instance [presidente] of Role)
(make-instance [jefe] of Role)
(make-instance [view] of Permission)
(make-instance [view] of Permission)
(make-instance [edit] of Permission)
(make-instance [delete] of Permission)
(make-instance of Proposition (subject [pedro]) (predicate (make-instance of IsIn (group [hombres]))) (time now))
(make-instance of Proposition (subject [juan]) (predicate (make-instance of IsIn (group [hombres]))) (time now))
(make-instance of Proposition (subject [ana]) (predicate (make-instance of IsIn (group [mujeres]))) (time now))
(make-instance of Proposition (subject [hombres]) (predicate (make-instance of Has (role [jefe]) (at [it]))) (time now))
(make-instance of Proposition (subject [jefe]) (predicate (make-instance of Can (at [base]) (perm [edit]))) (time now))
(find-all-instances ((?prop Proposition) (?Y6 Can)) (and (eq ?prop:subject [juan]) (eq ?Y6:at [it]) (eq ?Y6:perm [edit]) (eq ?prop:predicate ?Y6) (eq ?prop:time now)))
(defclass Name (is-a USER))
(defclass Thing (is-a Name))
(defclass Verb (is-a USER))
(defclass State (is-a Verb) )
...
(defclass IsIn (is-a State) (slot group (type INSTANCE)))
(defclass Has (is-a State) (slot role (type INSTANCE)) (slot at (type INSTANCE)))
(defclass IsSubContext (is-a State) (slot of (type INSTANCE)))
(make-instance [admin] of User)
(make-instance [anonymous] of Role)
(make-instance [member] of Role)
(make-instance [manager] of Role)
...
(make-instance of Proposition (subject [ana]) (predicate (make-instance of IsIn (group [mujeres]))) (time now))
(make-instance [jefe] of Role)
(make-instance of Proposition (subject [mujeres]) (predicate (make-instance of Has (role [jefe]) (at [finanzas]))) (time now))
(make-instance of Proposition (subject [hombres]) (predicate (make-instance of Has (role [jefe]) (at [it]))) (time now))
(make-instance of Proposition (subject [jefe]) (predicate (make-instance of Can (at [it]) (perm [view]))) (time now))
(make-instance of Proposition (subject [jefe]) (predicate (make-instance of Can (at [finanzas]) (perm [view]))) (time now))
(find-all-instances ((?prop Proposition) (?Y5 Can)) (and (eq ?prop:subject [ana]) (eq ?Y5:at [finanzas]) (eq ?Y5:perm [view]) (eq ?prop:predicate ?Y5) (eq ?prop:time now)))
(make-instance [ana] of User)
(make-instance [pedro] of User)
(make-instance [juan] of User)
(make-instance [mujeres] of Group)
...
(make-instance of Proposition (subject [jefe]) (predicate (make-instance of Can (at [finanzas]) (perm [view]))) (time now))
(find-all-instances ((?prop Proposition) (?Y5 Can)) (and (eq ?prop:subject [ana]) (eq ?Y5:at [finanzas]) (eq ?Y5:perm [view]) (eq ?prop:predicate ?Y5) (eq ?prop:time now)))
(find-all-instances ((?prop Proposition) (?Y6 Can)) (and (eq ?prop:subject [ana]) (eq ?Y6:at [finanzas]) (eq ?Y6:perm [edit]) (eq ?prop:predicate ?Y6) (eq ?prop:time now)))
(find-all-instances ((?prop Proposition) (?Y7 Can)) (and (eq ?prop:subject [ana]) (eq ?Y7:at [it]) (eq ?Y7:perm [view]) (eq ?prop:predicate ?Y7) (eq ?prop:time now)))
(find-all-instances ((?prop Proposition) (?Y8 Can)) (and (eq ?prop:subject [juan]) (eq ?Y8:at [it]) (eq ?Y8:perm [view]) (eq ?prop:predicate ?Y8) (eq ?prop:time now)))
(defclass Name (is-a USER))
(defclass Thing (is-a Name))
(defclass Verb (is-a USER))
(defclass State (is-a Verb) )
